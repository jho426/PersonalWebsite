      ...
      {(!menuOpen || windowWidth > 768) && (
        <>
          <img
            draggable={false}
            src={ExperienceTitle}
            className="my-10 w-5/6 lg:w-3/4 lg:my-20"
          ></img>
              ...
              <div className="flex flex-col w-full">
                <div className="flex flex-row rounded-lg w-5/6 p-4 border border-black mx-auto align-center gap-10">
                  <div className="w-full">
                    <h1 className="font-sans font-semibold tracking-tighter mb-4 text-5xl md:text-8xl lg:text-8xl">
                      {" "}
                      {item.title}{" "}
                    </h1>
                    <div className="flex flex-row w-full">
                      <p className="">{item.position}<br/>{item.date}</p>
                      <button
